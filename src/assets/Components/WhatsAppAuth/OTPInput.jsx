...
useEffect(() => {
    ...
    if (otp.length === 6) {
        ...
        dispatch(verifyOTP({ phone: fullPhone, otp }));
        }, 5000);
    }
    return () => clearTimeout(autoVerifyTimer);
}, [otp, countryCode, phoneNumber, dispatch]);
...
return (
    ...
    <div className="flex items-center space-x-2 mb-4">
        ...
        >
            {loading ? <FaSpinner className="animate-spin text-sm" /> : <><FaCheck className="text-sm mr-1" /> Verify</>}
        </button>
